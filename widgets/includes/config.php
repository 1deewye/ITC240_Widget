...
$config->nav1['game_list.php'] = 'Top 20 Games';
$config->nav1['daily.php'] = 'Dailies';
$config->nav1['contact.php'] = 'Contact';
...
//default page values for Clean
$config->siteName= 'David\'s Wicked Cool Shiznit';
...
switch(THIS_PAGE){
    case 'template.php':
        $config->title= 'Put PageID here';
        $config->pageHeader= 'My template page';
        $config->subHeader= 'Put more info about page here';
    break;
        
    case 'index.php':
        $config->title= 'Home Page';
        $config->pageHeader= 'My home page';
        $config->subHeader= 'This is the home page';
    break;
        
    case 'game_list.php':
        $config->title= 'Top 20 games';
        $config->pageHeader= 'Best of the Best';
        $config->subHeader= 'PLAY STUFF';
    break;
        
    case 'db-test.php':
        $config->title= 'A database test page';
        $config->pageHeader= 'Database Test Page';
        $config->subHeader= 'Check this page to see if your credentials are good';
    break;
        
    case 'daily.php':
        $config->title= 'My Daily page';
        $config->pageHeader= 'Daily Coffee Specials';
        $config->subHeader= 'All our coffee specials';
    break;
